...
const AccountNavigator: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name={AccountRoutes.EDIT_PROFILE} component={EditProfileScreen} />
      <Stack.Screen name={AccountRoutes.NOTIFICATIONS} component={NotificationsScreen} />
      ...
      <Stack.Screen name={AccountRoutes.HELP_SUPPORT} component={HelpSupportScreen} />
      <Stack.Screen name={AccountRoutes.ACHIEVEMENTS} component={AchievementsScreen} />
      <Stack.Screen name={AccountRoutes.REFERRAL}     component={ReferralScreen} />
    </Stack.Navigator>
  );
};
